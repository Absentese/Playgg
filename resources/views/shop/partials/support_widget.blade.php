<div id="support-widget" class="support-widget" data-chat-url="{{ route('support.chat') }}">
    <div id="support-panel" class="support-panel" hidden>
        ...
        <div class="support-panel__quick">
            ...
            <button type="button" class="support-quick-btn" data-message="Как купить игру в каталоге?">
                <i class="fas fa-gamepad me-1"></i> Каталог
            </button>
            <button type="button" class="support-quick-btn" data-message="Как пополнить Steam?">
